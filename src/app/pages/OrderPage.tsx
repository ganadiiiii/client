						...
						<div className="relative flex w-full h-full items-center justify-center">
							{isDeliveryHovered ? (
								<>
									...
									>
										<path
											d="M192.903 0.863281C203.527 0.863445 212.14 9.47574 212.14 20.0996V217.114C212.14 227.738 203.527 236.351 192.903 236.352H19.4629C8.83889 236.352 0.226589 227.738 0.226562 217.114V24.2725H73.1396L89.1104 0.863281H192.903Z"
											fill="#CAE4FF"
										/>
									</svg>
									<img
