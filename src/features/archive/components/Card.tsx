            ...
            >
                ...
                <div>
                    ...
                    <div
                        ...
                        style={{ fontFamily: "NexonLv1Gothic", fontSize: "14px", fontWeight: "400" }}
                    >
                        {date}
                    </div>
                    {/* 제목 */}
                    <div
                        ...
                        style={{ fontFamily: "Yidstreet", fontSize: "28px", fontWeight: "700" }}
                    >
                        {title}
                    </div>
                    {/* 메인/서브 꽃 */}
                    <div className="absolute left-[36px] top-[473px] flex flex-col items-start gap-[5px]">
                        <div className="flex gap-[10px] text-black items-baseline">
                            <span style={{ fontFamily: "Yidstreet", fontSize: "15px", fontWeight: "700" }}>Main</span>
                            <span style={{ fontFamily: "NexonLv1Gothic", fontSize: "14px", fontWeight: "400" }}>
                                {mainFlowers.join(", ")}
                            </span>
                            <span style={{ fontFamily: "Yidstreet", fontSize: "15px", fontWeight: "700" }}>Sub</span>
                            <span style={{ fontFamily: "NexonLv1Gothic", fontSize: "14px", fontWeight: "400" }}>
                                {subFlowers.join(", ")}
                            </span>
                        </div>
                        {/* 꽃말 */}
                        <div className="flex gap-[10px] text-black items-baseline">
                            <span style={{ fontFamily: "Yidstreet", fontSize: "15px", fontWeight: "700" }}>Floriography</span>
                            <span style={{ fontFamily: "NexonLv1Gothic", fontSize: "14px", fontWeight: "400" }}>
                                {floriography}
                            </span>
                        </div>
                    ...
                    <div className="absolute left-[36px] top-[549px] flex flex-row gap-[53px] text-black">
                        <div className="flex gap-2 items-baseline">
                            <span style={{ fontFamily: "Yidstreet", fontSize: "15px", fontWeight: "400" }}>To.</span>
                            <span style={{ fontFamily: "NexonLv1Gothic", fontSize: "14px", fontWeight: "400" }}>@{to}</span>
                        </div>
                        <div className="flex gap-2 items-baseline">
                            <span style={{ fontFamily: "Yidstreet", fontSize: "15px", fontWeight: "400" }}>From.</span>
                            <span style={{ fontFamily: "NexonLv1Gothic", fontSize: "14px", fontWeight: "400" }}>@{from}</span>
                        </div>
                    </div>
                </div>
            </motion.div>
