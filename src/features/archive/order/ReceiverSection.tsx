...
export function ReceiverSection() {
  ...
  return (
    ...
    >
      <h2 className="w-full text-start text-2xl font-bold text-black mb-2.5" style={{fontFamily: "NexonLv1Gothic"}}>받는 사람</h2>
      <div 
      ...
      {/* 이름 선택 */}
        <div className="mb-6">
            <div className="flex items-center gap-2">
                ...
                <img src={selectedFriend ? "/src/assets/icon-full.svg" : "/src/assets/icon-check.svg"} alt="check" className="w-5 h-5" />
            </div>
            <div className="block flex items-center gap-4 py-2">
                <h2 className="text-xl font-bold text-black" style={{ fontFamily: "NexonLv1Gothic" }}>
                    {selectedFriend ? selectedFriend.name : "받는 사람을 선택해 주세요"}
                </h2>
                {selectedFriend && (
