...
const CustomizingResultPage: React.FC = () => {
  ...
  return (
    <div className="relative w-full max-h-[1117px] bg-[#FCFBF6] bg-cover bg-center bg-no-repeat"
        style={{
        ...
        <div
            ...
            {/* 제목 */}
            <h1 className="text-[27.5px] font-bold text-black/80 mb-5 mt-20 z-40" style={{ fontFamily: 'NEXON Lv1 Gothic OTF' }}>
            커스텀 결과물
            </h1>
            ...
            >
                <img src="/src/assets/generate/rightbutton.svg" alt="Right Button" />
            </button>
            </div>
            ...
            <div className="flex flex-col items-center gap-6 mt-[-40px] z-40">
                <div className="relative">
                    <button className="w-20 h-20 rounded-full flex items-center justify-center">
                        <img src="/src/assets/generate/newdesign.svg" alt="New Design" className="w-20 h-20" />
                    </button>
                    <p className="text-xs text-black mt-2 text-center text-3 text-normal"
            ...
            <button 
                ...
                style={{
                background: 'linear-gradient(149deg, rgba(255, 255, 255, 0.1) 12%, rgba(255, 255, 255, 0.8) 60%)',
                boxShadow: '0px 3px 6px 0px rgba(0, 0, 0, 0.15), inset 2px 3px 1px 0px rgba(255, 255, 255, 0.51)'
                }}
            >
        ...
        {/* 좌측 패널 */}
        <aside
        role="dialog" aria-modal="true" aria-hidden={!leftPanelOpen}
        className={`
        ...
        `}
        style={{ backgroundImage: "url('/src/assets/generate/left.svg')", backgroundSize: 'cover' }}
        >
        ...
        <div className="relative h-full rounded-r-[23px] px-22 py-7">
            <div className="mb-4">
                <div className="flex items-end gap-6">
                    {/* 디자인 이름 */}
                    <div>
                        <label className="block mb-2 font-medium text-black text-[15.5px]" style={{ fontFamily: 'Pretendard-Regular' }}>디자인 이름</label>
                        ...
                        <input
                            ...
                            style={{ fontFamily: 'Pretendard-Regular' }}
                        />
                        <button className="w-[54px] h-[29px] bg-[#FFD1D4] rounded-sm text-sm" style={{ fontFamily: 'Pretendard-Regular' }}>변경</button>
                        </div>
                    </div>
                    {/* 꽃다발 크기 */}
                    <div>
            ...
            <div>
                <div className="flex items-center justify-between w-[341px] mb-2">
                    <label className="block font-medium text-black text-[15.5px] items-center" style={{ fontFamily: 'Pretendard-Regular' }}>메시지</label>
                    <button className=" w-[54px] h-[29px] bg-[#FFD1D4] rounded-sm text-sm" style={{ fontFamily: 'Pretendard-Regular' }}>저장</button>
                </div>
                <textarea
        ...
        {/* 우측 패널 */}
        <aside
        role="dialog" aria-modal="true" aria-hidden={!rightPanelOpen}
        className={`
        ...
        `}
        style={{ backgroundImage: "url('/src/assets/generate/right.svg')", backgroundSize: 'cover' }}
        >
